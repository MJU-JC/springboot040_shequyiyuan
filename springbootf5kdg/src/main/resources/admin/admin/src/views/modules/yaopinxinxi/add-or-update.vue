<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="药品编号" prop="yaopinbianhao">
          <el-input v-model="ruleForm.yaopinbianhao" 
              placeholder="药品编号" clearable  :readonly="ro.yaopinbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="药品编号" prop="yaopinbianhao">
              <el-input v-model="ruleForm.yaopinbianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="剂型" prop="jixing">
          <el-input v-model="ruleForm.jixing" 
              placeholder="剂型" clearable  :readonly="ro.jixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="剂型" prop="jixing">
              <el-input v-model="ruleForm.jixing" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="生产日期" prop="shengchanriqi">
          <el-input v-model="ruleForm.shengchanriqi" 
              placeholder="生产日期" clearable  :readonly="ro.shengchanriqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="生产日期" prop="shengchanriqi">
              <el-input v-model="ruleForm.shengchanriqi" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="生产单位" prop="shengchandanwei">
          <el-input v-model="ruleForm.shengchandanwei" 
              placeholder="生产单位" clearable  :readonly="ro.shengchandanwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="生产单位" prop="shengchandanwei">
              <el-input v-model="ruleForm.shengchandanwei" 
                placeholder="生产单位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.yaopintupian" label="药品图片" prop="yaopintupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.yaopintupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yaopinshuoming" label="药品说明" prop="yaopinshuoming">
                    <span v-html="ruleForm.yaopinshuoming"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.yaopinshuoming = this.ruleForm.yaopinshuoming.replace(reg,'../../../springbootf5kdg/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
