    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                ...
                <el-form-item :label="contents.inputTitle == 1 ? '剂型' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.jixing" placeholder="剂型" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.jixing" placeholder="剂型" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.jixing" placeholder="剂型" clearable></el-input>
                </el-form-item>
                <el-form-item :label="contents.inputTitle == 1 ? '批次号' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.picihao" placeholder="批次号" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.picihao" placeholder="批次号" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.picihao" placeholder="批次号" clearable></el-input>
                </el-form-item>
          <el-form-item>
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="生产日期">
		     <template slot-scope="scope">
                ...
                <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                    prop="shengchandanwei"
                    header-align="center"
		    label="生产单位">
		     <template slot-scope="scope">
                       {{scope.row.shengchandanwei}}
                     </template>
                </el-table-column>
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="yaopintupian"
                    header-align="center"
                    width="200"
                    label="药品图片">
                    <template slot-scope="scope">
                      <div v-if="scope.row.yaopintupian">
                        <img :src="scope.row.yaopintupian.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.picihao!='' && this.searchForm.picihao!=undefined){
            params['picihao'] = '%' + this.searchForm.picihao + '%'
          }
      this.$http({
