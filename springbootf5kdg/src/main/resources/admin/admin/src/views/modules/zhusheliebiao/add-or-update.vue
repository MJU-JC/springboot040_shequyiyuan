<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="注射药物列表" prop="zhusheyaowuliebiao">
          <el-input v-model="ruleForm.zhusheyaowuliebiao" 
              placeholder="注射药物列表" clearable  :readonly="ro.zhusheyaowuliebiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="注射药物列表" prop="zhusheyaowuliebiao">
              <el-input v-model="ruleForm.zhusheyaowuliebiao" 
                placeholder="注射药物列表" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zhusheliebiao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhusheliebiaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
