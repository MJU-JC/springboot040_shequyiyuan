<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="护士工号" prop="hushigonghao">
          <el-input v-model="ruleForm.hushigonghao" 
              placeholder="护士工号" clearable  :readonly="ro.hushigonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="护士工号" prop="hushigonghao">
              <el-input v-model="ruleForm.hushigonghao" 
                placeholder="护士工号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="护士姓名" prop="hushixingming">
          <el-input v-model="ruleForm.hushixingming" 
              placeholder="护士姓名" clearable  :readonly="ro.hushixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="护士姓名" prop="hushixingming">
              <el-input v-model="ruleForm.hushixingming" 
                placeholder="护士姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	zhaopian : false,
      ...
      rules: {
          hushigonghao: [
                { required: true, message: '护士工号不能为空', trigger: 'blur' },
          ],
          mima: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='hushigonghao'){
            this.ruleForm.hushigonghao = obj[o];
	    this.ro.hushigonghao = true;
            continue;
          }
          if(o=='mima'){
	    ...
	    this.ro.mima = true;
          ...
          if(o=='hushixingming'){
            this.ruleForm.hushixingming = obj[o];
	    this.ro.hushixingming = true;
            continue;
          }
          if(o=='xingbie'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `hushi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.hushiCrossAddOrUpdateFlag = false;
                  this.parent.search();
