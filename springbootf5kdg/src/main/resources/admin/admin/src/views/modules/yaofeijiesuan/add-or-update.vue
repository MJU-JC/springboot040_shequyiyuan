      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="总金额" prop="zongjine">
          <el-input v-model="ruleForm.zongjine" 
              placeholder="总金额" clearable  :readonly="ro.zongjine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="总金额" prop="zongjine">
              <el-input v-model="ruleForm.zongjine" 
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yaofeijiesuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yaofeijiesuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
